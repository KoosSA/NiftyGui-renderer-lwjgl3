...
class GlfwToNiftyKeyCodeConverter {
	...
	public static void setNiftyKeycodes() {
		KeyboardInputEvent.KEY_DOWN = GLFW_KEY_DOWN;
		KeyboardInputEvent.KEY_UP = GLFW_KEY_UP;
		KeyboardInputEvent.KEY_ESCAPE = GLFW_KEY_ESCAPE;
		KeyboardInputEvent.KEY_F1 = GLFW_KEY_F1;
		KeyboardInputEvent.KEY_LEFT = GLFW_KEY_LEFT;
		KeyboardInputEvent.KEY_RETURN = GLFW_KEY_ENTER;
		KeyboardInputEvent.KEY_SPACE = GLFW_KEY_SPACE;
		KeyboardInputEvent.KEY_RIGHT = GLFW_KEY_RIGHT;
		KeyboardInputEvent.KEY_TAB = GLFW_KEY_TAB;
		KeyboardInputEvent.KEY_DELETE = GLFW_KEY_DELETE;
		KeyboardInputEvent.KEY_BACK = GLFW_KEY_BACKSPACE;
		KeyboardInputEvent.KEY_END = GLFW_KEY_END;
		KeyboardInputEvent.KEY_HOME = GLFW_KEY_HOME;
		KeyboardInputEvent.KEY_X = GLFW_KEY_X;
		KeyboardInputEvent.KEY_RSHIFT = GLFW_KEY_RIGHT_SHIFT;
		KeyboardInputEvent.KEY_LSHIFT = GLFW_KEY_LEFT_SHIFT;
		KeyboardInputEvent.KEY_C = GLFW_KEY_C;
		KeyboardInputEvent.KEY_V = GLFW_KEY_V;
		KeyboardInputEvent.KEY_A = GLFW_KEY_A;
	}
